    ...
    def evaluationFunction(self, currentGameState, action):
        ...
        for ghost in newGhostStates:
          ...
          if ghost.scaredTimer > 0:
            ...
            score-=2*pow(max(6 - disGhost, 0), 2)
            #score -=20*1e6
          else:
            score -= pow(max(6 - disGhost, 0), 2)
            #score -=10*1e6
...
def betterEvaluationFunction(currentGameState):
    ...
    def _scoreFromCapsules(gameState):
      ...
      for Cap in gameState.getCapsules():
        score.append(50/manhattanDistance(gameState.getPacmanPosition(), Cap))
      if len(score) > 0:
        return max(score)
      else:
        return 0
    ...
    #else:
    #print(score + scoreGhosts + scoreFood + scoreCapsules)
    #print(currentGameState.getlayout())
...
class B551Agent3(AlphaBetaAgent):
    """
